...
echo python ./main.py --name $name --dataroot ./datasets/$dataset --dataset_name $dataset_name --mtl_method $mtl_method --imageSize $imageSize --model $model --use_skips --test_split test --use_resize --use_dropout --scale_to_mm $scale --n_classes $n_classes --test --tasks $tasks --save_samples